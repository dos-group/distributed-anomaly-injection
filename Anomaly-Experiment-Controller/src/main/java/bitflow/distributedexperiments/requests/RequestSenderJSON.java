package bitflow.distributedexperiments.requests;
...
public class RequestSenderJSON extends RequestSender {
    ...
    protected void logUnexpectedResponse(String requestType, HttpResponse<String> resp){
        logger.log(Level.WARNING, requestType + " request returned unexpected response.");
        this.logServerResponse(resp);
    }

    protected void logUnexpectedResponse(String requestType, HttpResponse<String> resp, JSONObject data){
        logger.log(Level.WARNING, requestType + " request returned unexpected response.");
        this.logServerResponse(resp, data);
    }

    protected void logServerResponse(HttpResponse<String> resp, JSONObject data){
